...
- **db_plants.py** - Работа с базой данных SQLite: инициализация, создание таблиц.
- **model.py** - Код для обучения модели.
- **photo.py** - Добавление изображений в датасет.
- **plant_recognition_model.keras** - Модель машинного обучения, обученная на изображениях растений.
...
**6. Установите переменные окружения.** Создайте файл *.env* в корне проекта и добавьте необходимые переменные окружения:
